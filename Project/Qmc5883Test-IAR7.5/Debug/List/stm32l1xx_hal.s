...
//        -Ol
//    List file    =  
//        D:\01work\proj\地磁\Code\Project\Qmc5883Test-IAR7.5\Debug\List\stm32l1xx_hal.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  186   __HAL_RCC_APB1_FORCE_RESET();
        MOVS     R0,#-1
        LDR.N    R1,??DataTable13  ;; 0x40023818
        STR      R0,[R1, #+0]
...
//  189   __HAL_RCC_APB2_FORCE_RESET();
        MOVS     R0,#-1
        LDR.N    R1,??DataTable13_1  ;; 0x40023814
        STR      R0,[R1, #+0]
...
//  192   __HAL_RCC_AHB_FORCE_RESET();
        MOVS     R0,#-1
        LDR.N    R1,??DataTable13_2  ;; 0x40023810
        STR      R0,[R1, #+0]
...
HAL_SuspendTick:
        LDR.N    R0,??DataTable13_5  ;; 0xe000e010
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x2
        LDR.N    R1,??DataTable13_5  ;; 0xe000e010
        STR      R0,[R1, #+0]
//  338 }
        BX       LR               ;; return
...
HAL_GetREVID:
        LDR.N    R0,??DataTable13_6  ;; 0xe0042000
        LDR      R0,[R0, #+0]
        LSRS     R0,R0,#+16
        BX       LR               ;; return
//  372 }
...
HAL_DBGMCU_EnableDBGSleepMode:
        LDR.N    R0,??DataTable13_7  ;; 0xe0042004
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable13_7  ;; 0xe0042004
        STR      R0,[R1, #+0]
//  390 }
        BX       LR               ;; return
